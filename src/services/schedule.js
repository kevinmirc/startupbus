      ...
      return $q(function (resolve, reject) {
        resolve({
          'Day 1 (July 31)': [
            ...
            {startTime: '6:45pm EDT', endTime: '7:00pm EDT', description: 'Board Bus', address: null},
            {startTime: '7:00pm EDT', endTime: '10:00pm EDT', description: 'Drive to Columbia, SC', address: null, icon: 'directions_bus'},
            {startTime: '10:00pm EDT', endTime: '10:30pm EDT', description: 'Hotel Checkin', address: '750 Saturn Pkwy Columbia, SC 29212', icon: 'local_hotel'},
          ],
          'Day 2 (August 1)': [
          ...
          'Day 3 (August 2)': [
            {startTime: '', endTime: '', description: 'Hotel Checkout & Boarding', address: '177 1st Ave N. Nashville, TN 37201', locationName: 'Nashville Downtown Hostel', icon: 'local_hotel'},
            {startTime: '', endTime: '', description: 'Boarding', address: null},
            {startTime: '', endTime: '', description: 'Boarding', address: null},
            {startTime: '', endTime: '', description: 'Drive to Birmingham', address: null, icon: 'directions_bus'},
            {startTime: '', endTime: '', description: 'Boarding', address: null, icon: 'directions_bus'},
            {startTime: '', endTime: '', description: 'Drive to Meridian', address: null, icon: 'directions_bus'},
            {startTime: '', endTime: '', description: 'Boarding', address: null},
            {startTime: '', endTime: '', description: 'Drive to New Orleans', address: null, icon: 'directions_bus'},
            {startTime: '', endTime: '', description: 'Hotel Checkin', address: '2001 St Charles Ave New Orleans, LA 70130', locationName: 'Clarion Hotel Grand Boutique', icon: 'local_hotel'},
          ],
          'Day 4 (August 3)': [
